...
class _ProfileFormPageState extends State<ProfileFormPage> {
  ...
  bool get esModoEdicion =>
      !widget.modoVisualizacion && widget.perfilAMostrar != null;
  ...
  void _guardarPerfil() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (esModoEdicion) {
        final personalVM = Provider.of<PersonalViewModel>(
          context,
          listen: false,
        );
        ...
        final exito = await personalVM.actualizarTrabajador(
          idTrabajador,
          nuevosDatos,
        );
        ...
        if (exito) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Error al actualizar el trabajador'),
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  validator: (value) =>
                      CampoValidators.validarRol(value, _cargoSeleccionado),
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _rolSeleccionado == null
                      ...
                      : _obtenerCargosParaRol()
                            ...
                            .toList(),
                  onChanged: (congelado || _rolSeleccionado == null)
                      ? null
                      : _alCambiarCargo,
