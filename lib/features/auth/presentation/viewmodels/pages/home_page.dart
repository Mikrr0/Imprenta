          ...
          children: [
            Card(
              ...
              child: ListTile(
                ...
                title: Text("Bernardo Arenas", style: TextStyle(fontWeight: FontWeight.bold, color: temaActual.textTheme.bodyLarge?.color)),
                subtitle: Text("Rol: Administrador", style: TextStyle(color: temaActual.textTheme.bodyMedium?.color)),
              ),
            ),
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ...
                  _construirTarjetaModulo(context, Icons.inventory, "Inventario"),
                  _construirTarjetaModulo(context, Icons.people, "Gestión de\nPersonal", accionAlPresionar: () {
